package dev.lemonclient.music.player.decoder.ogg;
...
import dev.lemonclient.music.player.decoder.ogg.jcraft.jogg.Packet;
import dev.lemonclient.music.player.decoder.ogg.jcraft.jogg.Page;
import dev.lemonclient.music.player.decoder.ogg.jcraft.jogg.StreamState;
import dev.lemonclient.music.player.decoder.ogg.jcraft.jogg.SyncState;
import dev.lemonclient.music.player.decoder.ogg.jcraft.jorbis.Block;
import dev.lemonclient.music.player.decoder.ogg.jcraft.jorbis.Comment;
import dev.lemonclient.music.player.decoder.ogg.jcraft.jorbis.DspState;
import dev.lemonclient.music.player.decoder.ogg.jcraft.jorbis.Info;
import dev.lemonclient.music.player.decoder.ogg.jcraft.oggdecoder.OggData;
...
public class OggDecoder implements IDecoder {
    private final LMusicPlayer player;
    /**
     ...
     */
    public OggDecoder(LMusicPlayer player) {
        this.player = player;
    }
    ...
    public void set(int time) {
        MusicManager.INSTANCE.warning("不支持中间播放");
    }
}
