...
public class SettingUtils {
    public static final FacingSettings facing = Modules.get().get(FacingSettings.class);
    public static final RangeSettings range = Modules.get().get(RangeSettings.class);
    ...
    public static boolean inAnchorPlaceRange(BlockPos pos) {
        return range.inAnchorPlaceRange(pos);
    }


    public static boolean inCrystalPlaceRange(BlockPos pos) {
        return range.inCrystalPlaceRange(pos, null);
    }
    ...
    public static boolean inAttackRangeNoTrace(Box bb, double eyeHeight, Vec3d feet) {
        return range.inAttackRangeNoTrace(bb, feet, null);
    }
    ...
    public static double attackRangeTo(Box bb, Vec3d feet) {
        return range.attackRangeTo(bb, feet, null, true);
    }
    ...
    public static PlaceData getPlaceDataANDDir(BlockPos pos, Predicate<Direction> predicate) {
        return facing.getPlaceDataAND(pos, predicate, null, true);
    }


    public static PlaceData getPlaceDataANDPos(BlockPos pos, Predicate<BlockPos> predicate) {
        return facing.getPlaceDataAND(pos, null, predicate, true);
    }
    ...
    public static PlaceData getPlaceDataANDDir(BlockPos pos, Predicate<Direction> predicate, boolean ignoreContainers) {
        return facing.getPlaceDataAND(pos, predicate, null, ignoreContainers);
    }


    public static PlaceData getPlaceDataANDPos(BlockPos pos, Predicate<BlockPos> predicate, boolean ignoreContainers) {
        return facing.getPlaceDataAND(pos, null, predicate, ignoreContainers);
    }
    ...
    //-------------------- Gui --------------------//
    /*public static boolean lineMeteor() {
        return gui.lineMeteor.get();
    }

    public static boolean meteorRainbow() {
        return gui.meteorRainbow.get();
    }

    public static boolean snowParticles() {
        return gui.snowParticles.get();
    }

    public static int spawnDelays() {
        return gui.spawnDelays.get();
    }

    public static boolean particles() {
        return gui.particles.get();
    }

    public static GuiSettings.ParticlesMode particlesMode() {
        return gui.particlesMode.get();
    }*/
}
