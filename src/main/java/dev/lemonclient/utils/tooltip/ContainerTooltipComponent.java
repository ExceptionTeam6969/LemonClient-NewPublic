package dev.lemonclient.utils.tooltip;
...
public class ContainerTooltipComponent implements TooltipComponent, MeteorTooltipData {
    private static final Identifier TEXTURE_CONTAINER_BACKGROUND = new Identifier(LemonClient.MOD_ID, "textures/container.png");
