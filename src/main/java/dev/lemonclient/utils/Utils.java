...
import dev.lemonclient.mixin.*;
import dev.lemonclient.systems.modules.Module;
import dev.lemonclient.systems.modules.Modules;
import dev.lemonclient.systems.modules.render.BetterTooltips;
import dev.lemonclient.systems.modules.world.Timer;
import dev.lemonclient.utils.player.EChestMemory;
import dev.lemonclient.utils.render.PeekScreen;
import dev.lemonclient.utils.render.color.Color;
import dev.lemonclient.utils.world.BlockEntityIterator;
import dev.lemonclient.utils.world.ChunkIterator;
...
public class Utils {
    ...
    public static void init() {
        LemonClient.EVENT_BUS.subscribe(Utils.class);
    }
    ...
    public static String getModuleName(String name) {
        ...
        if (modules == null) {
            LemonClient.LOG.warn("Module instantiation before Modules initialized.");
            return name;
        }
    ...
    public static int getRenderDistance() {
        return Math.max(mc.options.getViewDistance().getValue(), ((IClientPlayNetworkHandler) mc.getNetworkHandler()).getChunkLoadDistance());
    }
    ...
    public static String getWorldName() {
        ...
        if (mc.isInSingleplayer()) {
            ...
            File folder = ((IMinecraftServer) mc.getServer()).getSession().getWorldDirectory(mc.world.getRegistryKey()).toFile();
    ...
    public static void rightClick() {
        ((dev.lemonclient.mixininterface.IMinecraftClient) mc).rightClick();
    }
    ...
    public static boolean isLoading() {
        ResourceReloadLogger.ReloadState state = ((IResourceReloadLogger) ((IMinecraftClient) mc).getResourceReloadLogger()).getReloadState();
        return state == null || !((IReloadState) state).isFinished();
    }
