...
import dev.lemonclient.mixin.IHorseScreenHandler;
...
public class SlotUtils {
    ...
    private static int creativeInventory(int i) {
        if (!(mc.currentScreen instanceof CreativeInventoryScreen) || ICreativeInventoryScreen.getSelectedTab() != Registries.ITEM_GROUP.get(ItemGroups.INVENTORY))
            return -1;
