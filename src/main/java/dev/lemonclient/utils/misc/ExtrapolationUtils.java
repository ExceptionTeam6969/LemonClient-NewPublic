...
import dev.lemonclient.mixininterface.IEpic;
...
public class ExtrapolationUtils {
    ...
    public static void preInit() {
        LemonClient.EVENT_BUS.subscribe(ExtrapolationUtils.class);
    }
    ...
    public static void extrapolateMap(Map<AbstractClientPlayerEntity, Box> old, IEpic<AbstractClientPlayerEntity, Integer> extrapolation, IEpic<AbstractClientPlayerEntity, Integer> smoothening) {
        old.clear();
    ...
    public static Box extrapolate(AbstractClientPlayerEntity player, List<Vec3d> m, int extrapolation, int smoothening) {
        ...
        boolean onGround = CombatInfo.inside(player, box.offset(0, -0.04, 0));
        ...
        for (int i = 0; i < extrapolation; i++) {
            ...
            onGround = CombatInfo.inside(player, box.offset(0, -0.04, 0));
