...
import dev.lemonclient.mixin.ICrossbowItem;
import dev.lemonclient.mixin.IProjectileInGround;
import dev.lemonclient.mixininterface.IVec3d;
import dev.lemonclient.utils.Utils;
import dev.lemonclient.utils.misc.MissHitResult;
...
public class ProjectileEntitySimulator {
    ...
    public boolean set(Entity user, ItemStack itemStack, double simulated, boolean accurate, double tickDelta) {
        ...
        if (item instanceof BowItem) {
            ...
            if (CrossbowItem.hasProjectile(itemStack, Items.FIREWORK_ROCKET)) {
                set(user, 0, ICrossbowItem.getSpeed(itemStack), simulated, 0, 0.6, accurate, tickDelta);
            } else
                set(user, 0, ICrossbowItem.getSpeed(itemStack), simulated, 0.05000000074505806, 0.6, accurate, tickDelta);
    ...
    public boolean set(Entity entity, boolean accurate, double tickDelta) {
        ...
        if (entity instanceof PersistentProjectileEntity && ((IProjectileInGround) entity).getInGround())
            return false;
