...
import dev.lemonclient.asm.Asm;
import dev.lemonclient.managers.MixinBootstrapManager;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "dev.lemonclient.mixin";
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        ...
        } else if (mixinClassName.endsWith("MixinPlayerEntityRenderer")) {
