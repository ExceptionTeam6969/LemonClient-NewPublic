...
import dev.lemonclient.gui.tabs.builtin.HudTab;
...
public class HudEditorScreen extends WidgetScreen implements Snapper.Container {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        double s = LemonClient.mc.getWindow().getScaleFactor();
    ...
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        ...
        if (moved) {
            ...
            if (button == GLFW.GLFW_MOUSE_BUTTON_LEFT) {
                ...
                if (hovered != null) LemonClient.mc.setScreen(new HudElementScreen(theme, hovered));
                else LemonClient.mc.setScreen(new AddHudElementScreen(theme, lastMouseX, lastMouseY));
            }
        }
    ...
    public static boolean isOpen() {
        Screen s = LemonClient.mc.currentScreen;
