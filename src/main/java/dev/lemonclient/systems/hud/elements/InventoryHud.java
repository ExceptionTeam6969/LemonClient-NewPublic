...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = new Identifier(LemonClient.MOD_ID, "textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = new Identifier(LemonClient.MOD_ID, "textures/container-transparent.png");
