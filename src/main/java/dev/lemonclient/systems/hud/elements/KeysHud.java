...
public class KeysHud extends HudElement {
    public static final HudElementInfo<KeysHud> INFO = new HudElementInfo<>(Hud.GROUP, "Keys", "Draws pressed movement keys.", KeysHud::new);
