...
import dev.lemonclient.mixin.IItemStack;
import dev.lemonclient.settings.*;
import dev.lemonclient.systems.modules.Categories;
import dev.lemonclient.systems.modules.Module;
import dev.lemonclient.systems.modules.Modules;
import dev.lemonclient.systems.modules.combat.AutoTotem;
...
public class AutoReplenish extends Module {
    ...
    private void setItem(int slot, ItemStack stack) {
        ...
        ((IItemStack) (Object) s).setItem(stack.getItem());
        s.setCount(stack.getCount());
        s.setNbt(stack.getNbt());
        if (stack.isEmpty()) ((IItemStack) (Object) s).setItem(Items.AIR);
    }
}
