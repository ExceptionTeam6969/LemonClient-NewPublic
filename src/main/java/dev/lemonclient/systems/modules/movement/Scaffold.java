...
public class Scaffold extends Module {
    public Scaffold() {
        super(Categories.Movement, "Scaffold", "Places blocks under your feet to help you to move.");
    }
                    ...
                    if (obsidian >= 0) {
                        ...
                        if (hand == Hand.OFF_HAND) {
                            ...
                            switch (switchMode.get()) {
                                ...
                                case InvSwitch -> {
                                    obsidian = InvUtils.invSwitch(inventory.slot()) ? inventory.count() : -1;
                        ...
                        for (int i = 0; i < Math.min(obsidian, toPlace.size()); i++) {
                            ...
                            if (placeData.valid()) {
                                if (SettingUtils.shouldRotate(RotationType.BlockPlace))
                                    Managers.ROTATION.start(placeData.pos(), 1, RotationType.BlockPlace, Objects.hash(name + "placing"));
