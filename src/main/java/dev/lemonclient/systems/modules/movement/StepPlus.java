...
public class StepPlus extends Module {
    public StepPlus() {
        super(Categories.Movement, "Step+", "Step be worked in strict servers.");
    }
    ...
    public boolean shouldPauseWeb() {
        return isActive() && pauseWeb.get() && EntityInfo.isWebbed(mc.player);
    }
}
