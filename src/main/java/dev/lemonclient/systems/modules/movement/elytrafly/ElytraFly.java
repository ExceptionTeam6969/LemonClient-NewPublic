package dev.lemonclient.systems.modules.movement.elytrafly;
...
import dev.lemonclient.systems.modules.movement.elytrafly.modes.Packet;
import dev.lemonclient.systems.modules.movement.elytrafly.modes.Pitch40;
import dev.lemonclient.systems.modules.movement.elytrafly.modes.Vanilla;
import dev.lemonclient.systems.modules.player.ChestSwap;
import dev.lemonclient.systems.modules.player.Rotation;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        LemonClient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        LemonClient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        LemonClient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        LemonClient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
