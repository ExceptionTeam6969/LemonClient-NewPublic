...
import dev.lemonclient.utils.render.MeshVertexConsumerProvider;
import dev.lemonclient.utils.render.RenderUtils;
import dev.lemonclient.utils.render.SimpleBlockRenderer;
...
public class StorageESP extends Module {
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (mode.get() == Mode.Shader)
            PostProcessShaders.STORAGE_OUTLINE.endRender(() -> mesh.render(event.matrices, 1.0f));
    }
