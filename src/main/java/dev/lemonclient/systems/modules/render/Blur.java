...
import dev.lemonclient.renderer.Framebuffer;
import dev.lemonclient.renderer.GL;
import dev.lemonclient.renderer.PostProcessRenderer;
import dev.lemonclient.renderer.Shader;
...
public class Blur extends Module {
    public Blur() {
        ...
        LemonClient.EVENT_BUS.subscribe(new ConsumerListener<>(RenderAfterWorldEvent.class, event -> onRenderAfterWorld()));
    }
