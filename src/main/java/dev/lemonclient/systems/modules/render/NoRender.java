...
import dev.lemonclient.events.world.ParticleEvent;
...
public class NoRender extends Module {
    ...
    private final Setting<Boolean> noToasts = sgOverlay.add(new BoolSetting.Builder()
        .name("Toasts")
    ...
    private final Setting<Boolean> antiPlayerCollision = sgOverlay.add(new BoolSetting.Builder()
        .name("Anti Player Collision")
        .description("")
        .defaultValue(true)
        .build()
    );
    ...
    public boolean antiPlayerCollision() {
        return isActive() && antiPlayerCollision.get();
    }
