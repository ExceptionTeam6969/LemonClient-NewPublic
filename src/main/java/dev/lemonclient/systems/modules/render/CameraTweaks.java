...
import dev.lemonclient.events.game.ChangePerspectiveEvent;
...
public class CameraTweaks extends Module {
    ...
    private void onMouseScroll(MouseScrollEvent event) {
        if (mc.options.getPerspective() == Perspective.FIRST_PERSON || mc.currentScreen != null || !scrollingEnabled.get() || (scrollKeybind.get().isValid() && !scrollKeybind.get().isPressed()))
            return;
