...
import dev.lemonclient.events.world.SeedChangedEvent;
import dev.lemonclient.events.world.TickEvent;
import dev.lemonclient.settings.*;
import dev.lemonclient.systems.modules.Categories;
import dev.lemonclient.systems.modules.Module;
import dev.lemonclient.utils.player.PlayerUtils;
import dev.lemonclient.utils.seeds.Seed;
import dev.lemonclient.utils.seeds.Seeds;
import dev.lemonclient.utils.world.Ore;
...
public class OreSim extends Module {
    public OreSim() {
        super(Categories.World, "Ore Sim", "Xray on crack.");
