...
public class Offhand extends Module {
    ...
    private void onTick(TickEvent.Pre event) throws InterruptedException {
        ...
        // Always Gap
        else if ((mc.player.getMainHandStack().getItem() instanceof SwordItem || mc.player.getMainHandStack().getItem() instanceof AxeItem) && alwaysSwordGap.get())
            currentItem = Item.EGap;
        ...
        // Always Pot
        else if ((mc.player.getMainHandStack().getItem() instanceof SwordItem || mc.player.getMainHandStack().getItem() instanceof AxeItem) && alwaysPot.get())
            currentItem = Item.Potion;
