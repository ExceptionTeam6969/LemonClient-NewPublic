package dev.lemonclient.commands;
...
public class Commands {
    ...
    public static final CommandSource COMMAND_SOURCE = new ClientCommandSource(null, LemonClient.mc);
