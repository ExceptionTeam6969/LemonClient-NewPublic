...
public class EnchantCommand extends Command {
    ...
    private void syncItem() {
        LemonClient.mc.setScreen(new InventoryScreen(LemonClient.mc.player));
        LemonClient.mc.setScreen(null);
    }

    private ItemStack tryGetItemStack() throws CommandSyntaxException {
        if (!LemonClient.mc.player.isCreative()) throw NOT_IN_CREATIVE.create();
    ...
    private ItemStack getItemStack() {
        ...
        if (itemStack == null) itemStack = LemonClient.mc.player.getOffHandStack();
