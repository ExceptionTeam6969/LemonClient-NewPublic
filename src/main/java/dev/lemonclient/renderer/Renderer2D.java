...
import dev.lemonclient.gui.renderer.packer.TextureRegion;
...
public class Renderer2D {
    ...
    public static final double circleFull = circleHalf * 2;
    ...
    public void drawCircle(double x, double y, double rad, Color color) {
        circlePart(x, y, rad, circleNone, circleFull, color);
    }
