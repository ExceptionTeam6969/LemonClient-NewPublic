...
import dev.lemonclient.mixin.IBufferRenderer;
...
public class GL {
    ...
    public static void bindVertexArray(int vao) {
        ...
        if (changeBufferRenderer) IBufferRenderer.setCurrentVertexBuffer(null);
    }
    ...
    public static void bindTexture(Identifier id) {
        ...
        LemonClient.mc.getTextureManager().bindTexture(id);
    }
