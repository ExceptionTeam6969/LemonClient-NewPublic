...
class GlyphMap {
    ...
    int width, height, pixelHeight;

    boolean generated = false;

    public GlyphMap(int pixelHeight, char from, char to, Font[] fonts, Identifier identifier) {
        fromIncl = from;
        toExcl = to;
        font = fonts;
    ...
    public void generate() {
        ...
        while (generatedChars <= range) {
            ...
            glyphs1.add(new Glyph(currentX, currentY, width, height, 0, 0, currentChar, this));
