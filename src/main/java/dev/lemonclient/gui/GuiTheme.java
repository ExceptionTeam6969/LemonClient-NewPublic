...
import dev.lemonclient.gui.screens.ModuleScreen;
import dev.lemonclient.gui.screens.ModulesScreen;
import dev.lemonclient.gui.screens.NotebotSongsScreen;
import dev.lemonclient.gui.screens.ProxiesScreen;
import dev.lemonclient.gui.screens.accounts.AccountsScreen;
...
import dev.lemonclient.gui.utils.SettingsWidgetFactory;
import dev.lemonclient.gui.utils.WindowConfig;
import dev.lemonclient.gui.widgets.*;
import dev.lemonclient.gui.widgets.containers.*;
import dev.lemonclient.gui.widgets.input.*;
import dev.lemonclient.gui.widgets.pressable.*;
...
public abstract class GuiTheme implements ISerializable<GuiTheme> {
    ...
    public GuiTheme(String name) {
        if (this instanceof BozeGuiTheme) {
            this.name = "Boze";
        } else if (this instanceof CLionGuiTheme) {
            this.name = "CLion";
        } else if (this instanceof MercuryGuiTheme) {
            this.name = "Mercury";
        } else {
            this.name = name;
        }
